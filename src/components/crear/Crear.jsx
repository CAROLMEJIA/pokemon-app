    ...
    return(
        <div className={styles.contenedor}>
            ...
            <form onSubmit={(e) => enviarInfo(e)} className={styles.formulario}>
                ...
                <input value={input.hp} name="hp" placeholder="Life" onChange={(e) => capturarInputs(e)}></input>
                ...
                <div className={styles.contSelect}>
                        <select value={input.types} onChange={(e) => capSelectTypes(e)} className={styles.selectTypes}>
                            {
                                allTypes.map(t => {
                ...
                <button className={styles.boton} type="submit" disabled={Object.keys(error).length < 1 ? false : true}>Crear</button>
